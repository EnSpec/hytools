...
Configuration json file is slightly different from the basic configuration (an example for topo correction: [nc_topo_correct_config.json](https://github.com/EnSpec/hytools/blob/master/examples/configs/nc_topo_correct_config.json)).
...
There is a sample image correct script for nc files and GLT ( [image_correct_export_nc.py](https://github.com/EnSpec/hytools/blob/master/scripts/image_correct_export_nc.py)).
...
![Before](../../examples/img/emit_aus_subset1_uncorr.png "Before")

![After](../../examples/img/emit_aus_subset1_topo.png "After")
...
![RGB without GLT](../../examples/img/emit_001_20231101T024133_2330502_014_rgb.jpg "Raw")

Export warped image with GLT

![RGB with GLT](../../examples/img/emit_001_20231101T024133_2330502_014_rgb_warp.jpg "warp")
...
There is a sample trait export script for nc files and GLT ( [trait_estimate_nc.py](https://github.com/EnSpec/hytools/blob/master/scripts/trait_estimate_nc.py)).
