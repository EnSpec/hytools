...
def open_netcdf(hy_obj, sensor,anc_path = {}, glt_path = {}):
    ...
    if bool(glt_path)==True:
        ...
        if sensor == 'EMIT':
            ...
            hy_obj.map_info = ['UTM','1','1',str(geotransform[0]),str(geotransform[3]),str(geotransform[1]),str(-geotransform[5]),utm_zone_tag[:-1],utm_zone_dict[utm_zone_tag[-1]],'WGS-84']
